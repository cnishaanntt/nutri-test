...
app.get('/nutrient',async(req, res) =>{  
    ...
    request({
        url: 'https://api.nal.usda.gov/ndb/reports/?ndbno='+req.query.num+'&type=b&format=json&api_key=G8dZT37oNKQBFL1jI3wBb0k0GcEbcGLXM77redC7',
        json: true
    }, function (error, response, foodContent) {
        if (!error && response.statusCode === 200) {
            console.log(foodContent) // Print the json response
            res.render('nutrient',{
